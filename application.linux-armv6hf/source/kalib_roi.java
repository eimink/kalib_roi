...
public class kalib_roi extends PApplet {
...
public void drawScreen1(String target, String screen) {
  pushMatrix();
  textFont(font);
...
public void drawGameScreen(int i, int t1, int t2, int t3) {
  pushMatrix();
  textFont(font);
  textAlign(CENTER,CENTER);
...
public void draw(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "kalib_roi" };
    if (passedArgs != null) {
